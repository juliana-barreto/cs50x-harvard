...
UPDATE shows SET title = 'It''s Always Sunny in Philadelphia' WHERE title LIKE 'it%s always sunny in%';
...
UPDATE shows SET title = 'Law & Order' WHERE title LIKE 'law and order';